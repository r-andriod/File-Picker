...
/**
 * DirectoryPopUpWindow
 * Created by renwoxing on 2017/11/10.
 */
public class DirectoryPopUpWindow extends PopupWindow implements View.OnClickListener {
    ...
    public DirectoryPopUpWindow(Context context, BaseAdapter adapter) {

        super(context);
        final View view = View.inflate(context, R.layout.pop_directory, null);
    ...
    private void exitAnimator() {
        ...
        set.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                DirectoryPopUpWindow.super.dismiss();
            }
